...
export default {
    ...
    mounted () {
  	const storeMenuData = this.$store.getters.menuList
  	if (storeMenuData.length) {
  		this.menuArr = storeMenuData
        } else {
  		this.menuArr = getMenuByRouter(storeMenuData.concat(formatMenuToRouter()), '')
        }
        /**
